...
! modified by Lihuiyan 2024-12-06 修改为CW76势
                        READ(10,*)V0,R0,A0
            r1 = 1.233D0*ap**(1.D0/3.D0) - 0.978D0/ap**(1.D0/3.D0)
            r2 = 1.233D0*at**(1.D0/3.D0) - 0.978D0/at**(1.D0/3.D0)
            a0 = 0.63D0
            R0 = (r1+r2)
            r12 = r1*r2/(r1+r2)
            V0 = 50*r12
...
CX      CALL POTSHAPE
 ...
 81         FORMAT('-----------------------------------------------'
     ...
     !!&         IROT_NUM )
          !DO I=1,NLEVEL
          ! modified by Lihuiyan 2024-12-06 修改实部为CW76势
          XX=EXP((RPOT-R0)/A0)
...
!!return
!end
! 2024-11-19 修改为CW76势 by Lihuiyan

c          gamma = 0.95D0*(1.D0-1.8D0*(ap-2.D0*zp)/ap*(at-2.D0*zt)/at)
c          V0 = 16.D0*PI*gamma*r12*A0
        IF ( R.LT.50.D0 ) THEN
           vn=-v0/(exp((r-R0)/a0/pow))**pow
        ELSE
           vn = 0.D0
        ENDIF
